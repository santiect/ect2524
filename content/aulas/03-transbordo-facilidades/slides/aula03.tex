...
\begin{frame}
	\frametitle{Por que isso importa (além do experimento)}
	\begin{itemize}
		\item Trocar dados em experimentos é só \textbf{um} dos usos;
		\item O ponto maior: chamar solver a partir de uma linguagem de
			\textbf{propósito geral} deixa a otimização virar
			\textbf{parte de um software};
		\item Ou seja, dá para \textbf{embarcar} o modelo em:
		\begin{itemize}
