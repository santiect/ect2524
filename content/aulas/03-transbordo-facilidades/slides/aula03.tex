...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			\item modelar (parâmetros, variáveis, objetivo, restrições);
			\item escolher e \textbf{justificar} o objetivo: soma das
				distâncias (p-mediana) ou a maior distância (p-centro);
			\item escrever \texttt{facilidades.mod};
			\item escrever \texttt{ler\_dados} e o script \texttt{amplpy};
			\item resolver as \textbf{3 instâncias} e montar uma tabela
