...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.75\textwidth]{images/chefe1.jpg}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.75\textwidth]{images/chefe2.jpg}
	\end{center}
\end{frame}
...
\begin{frame}
	\frametitle{Resposta 3 --- ``Não consegui, mas ninguém mais também
		conseguiu''}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/chefe3.jpg}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Nesta disciplina, tratamos os dois sob o mesmo enfoque —
			...
			tempo polinomial, por um algoritmo \textbf{determinístico}.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Definição}
		...
		é possível verificar sua correção em tempo polinomial, por um
		algoritmo \textbf{determinístico} (o mesmo tipo de algoritmo comum,
		sem "adivinhação" nem paralelismo infinito).
	\end{block}
	\begin{itemize}
		\item A classe \textbf{NP} reúne todos os problemas de busca com
			essa propriedade;
		\item É o \textbf{verificador} que é polinomial e determinístico —
			não há garantia nenhuma sobre o tempo de \textbf{encontrar} a
			solução candidata; NP não significa "não polinomial", significa
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textbf{NP}: problemas de busca cuja solução, uma vez dada,
			pode ser verificada em tempo polinomial por um algoritmo
			determinístico;
