...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textit{Atenção}: AMPL termina instruções em \texttt{;},
			Python não -- cuidado ao alternar as duas no Colab.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Planejamento do refeitório de uma fábrica, com
			nutricionista;
		\item Objetivo: \textbf{reduzir custo} sem \textbf{prejudicar a
			saúde};
		\item Mínimos diários: proteínas, cálcio, sódio, ferro,
			vitaminas;
		\item Máximo diário: calorias;
		\item Problema da Dieta: alimentos + quantidades de menor custo
			que atendem às exigências nutricionais.
	\end{itemize}
\end{frame}
