...
\subtitle{Escolher os locais de um exame nacional}
...
\begin{frame}
	\frametitle{Candidatos, locais e distâncias}
	\begin{center}
...
\begin{frame}
	\frametitle{Uma solução possível}
	\begin{center}
	\begin{tikzpicture}[scale=0.92,
...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item Mais os indicadores de resolução, com \textbf{60 s} de
...
\begin{frame}
	...
	\begin{itemize}
		\item A instância 3 é bem maior: parte da tarefa é observar se ela
			é resolvida na otimalidade dentro dos 60 s de limite, ou se
